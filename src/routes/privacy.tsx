  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Privacy Policy | MatchPoint" },
      {
        ...
        content: "What data MatchPoint collects, how we use it, and your rights.",
      },
  ...
  component: () => (
    <SiteShell>
      ...
      <section className="mx-auto max-w-3xl space-y-6 px-4 py-16 text-sm leading-relaxed text-muted-foreground sm:px-6">
        ...
        <p>
          Account info (email, username, country), gameplay data (match results, evidence uploads)
          and device data for fraud prevention.
        </p>
        <h2 className="text-base font-semibold text-foreground">How we use it</h2>
        <p>
          To operate the platform, verify match results, prevent cheating, process payouts and
          improve our service.
        </p>
        <h2 className="text-base font-semibold text-foreground">Your rights</h2>
        <p>
          You can request export or deletion of your data at any time from your profile settings, or
          by sending us a message through our{" "}
